! function(e, t) {
    ...
    $(window).scroll(function() {
        100 < $(window).scrollTop() ? $(".navbar").addClass("navbar-scroll-down") : $(".navbar").removeClass("navbar-scroll-down")
    }), $(".navbar .navbar-toggle").click(function() {
        $(".navbar").toggleClass("sidenav-show")
    }), $(".navbar .sidenav-show .link a").click(function() {
        $(".navbar").removeClass("sidenav-show")
        ...
        if (0 !== $id.length) {
            ...
            $("body, html").animate({
                scrollTop: pos
            }), $(".navbar a").removeClass("active"), $(this).addClass("active", 1e3)
        }
    })
}), $(function() {
    $(".form-group label").click(function() {
        $(".form-group label").removeClass("active"), $(this).addClass("active"), $(this).next().focus()
    }), $("input[type=text]").focusin(function() {
        $(this).prev().addClass("active")
    }), $("input[type=text]").focusout(function() {
        0 === $(this).val().length && $(this).prev().removeClass("active")
    })
}), $(function() {
    $(".tabs ul li").click(function() {
        $(".tabs ul li").removeClass("active"), $(this).addClass("active")
    })
});